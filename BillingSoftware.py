...
class Bill_App:
    def __init__(self,root):
       ...
       c_name_lbl=Label(F1,text="Customer Name",bg=bg_color,fg="white",font=("times new roman",15,"bold")).grid(row=0,column=0,padx=20,pady=0)
       c_name_txt=Entry(F1,width=15,textvariable=self.c_name,font="arial 15",bd=7,relief=SUNKEN).grid(row=0,column=1,pady=5,padx=10)

       c_phon_lbl=Label(F1,text="Mobile Number",bg=bg_color,fg="white",font=("times new roman",15,"bold")).grid(row=0,column=2,padx=20,pady=0)
       c_phon_txt=Entry(F1,width=15,textvariable=self.c_phon,font="arial 15",bd=7,relief=SUNKEN).grid(row=0,column=3,pady=5,padx=10)

       c_bill_lbl=Label(F1,text="Bill Number",bg=bg_color,fg="white",font=("times new roman",15,"bold")).grid(row=0,column=4,padx=20,pady=0)
       ...
       c1_lbl=Label(F4,text="Butter Milk",font=("times new roman",16,"bold"),bg=bg_color,fg="lightgreen").grid(row=0,column=0,padx=10,pady=10,sticky="w")
       c1_txt=Entry(F4,width=10,textvariable=self.butter_milk,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=0,column=1,padx=10,pady=10)
       ...
       c3_lbl=Label(F4,text="Coke",font=("times new roman",16,"bold"),bg=bg_color,fg="lightgreen").grid(row=2,column=0,padx=10,pady=10,sticky="w")
       ...
       c4_txt=Entry(F4,width=10,textvariable=self.ThumbesUp,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=3,column=1,padx=10,pady=10)
       ...
       c5_txt=Entry(F4,width=10,textvariable=self.AppyFizz,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=4,column=1,padx=10,pady=10)


       c6_lbl=Label(F4,text="Red Bull",font=("times new roman",16,"bold"),bg=bg_color,fg="lightgreen").grid(row=5,column=0,padx=10,pady=10,sticky="w")
       ...
       m3=Label(F6,text="Total Drinks Price",bg=bg_color,fg="white",font=("times new roman",14,"bold")).grid(row=2,column=0,padx=20,pady=1,sticky="w")
       ...
       c3=Label(F6,text="Drinks Tax",bg=bg_color,fg="white",font=("times new roman",14,"bold")).grid(row=2,column=2,padx=20,pady=1,sticky="w")
       ...
       total_bttn=Button(btn_F,command=self.total,text="Total",bg="cadetblue",fg="white",bd=2,pady=15,width=10,font="arial 15 bold").grid(row=0,column=0,padx=5,pady=6)
       GBill_bttn=Button(btn_F,text="Generate Bill",command=self.bill_area,bg="cadetblue",fg="white",bd=2,pady=15,width=10,font="arial 15 bold").grid(row=0,column=1,padx=5,pady=6)
       Clear_bttn=Button(btn_F,text="Clear",command=self.clear_data,bg="cadetblue",fg="white",bd=2,pady=15,width=10,font="arial 15 bold").grid(row=0,column=2,padx=5,pady=6)
       Exit_bttn=Button(btn_F,text="Exit",command=self.Exit_app,bg="cadetblue",fg="white",bd=2,pady=15,width=10,font="arial 15 bold").grid(row=0,column=3,padx=5,pady=6)
       self.welcome_bill()
    ...
    def total(self):
        ...
        self.c_hs_p=self.shampoo.get()*180
        ...
        self.d_m_p=self.butter_milk.get()*60
        self.d_c_p=self.pepsi.get()*60
        self.d_f_p=self.coke.get()*60
        self.d_t_p=self.ThumbesUp.get()*80
        self.d_l_p=self.AppyFizz.get()*120
        self.d_r_p=self.RedBull.get()*120
    ...
    def bill_area(self):
        if self.c_name.get()=="" or self.c_phon.get()=="":
            ...
            if self.shampoo.get()!=0:
                self.txtarea.insert(END,f"\n Hair Shampoo\t\t {self.shampoo.get()}\t\t {self.c_hs_p}")
            if self.gel.get()!=0:
            ...
            if self.butter_milk.get()!=0:
                self.txtarea.insert(END,f"\n Butter Milk\t\t {self.butter_milk.get()}\t\t {self.d_m_p}")
            if self.pepsi.get()!=0:
                self.txtarea.insert(END,f"\n Pepsi\t\t {self.pepsi.get()}\t\t {self.d_c_p}")
            if self.coke.get()!=0:
                self.txtarea.insert(END,f"\n Coke\t\t {self.coke.get()}\t\t {self.d_f_p}")
            if self.ThumbesUp.get()!=0:
                self.txtarea.insert(END,f"\n Thumbes Up\t\t {self.ThumbesUp.get()}\t\t {self.d_t_p}")
            if self.AppyFizz.get()!=0:
                self.txtarea.insert(END,f"\n Appy Fizz\t\t {self.AppyFizz.get()}\t\t {self.d_l_p}")
            if self.RedBull.get()!=0:
                self.txtarea.insert(END,f"\n Red Bull\t\t {self.RedBull.get()}\t\t {self.d_r_p}")
    ...
    def save_bill(self):
        ...
        if op>0:
            ...
            f1=open("C:\\Users\\HIYA\\OneDrive\\Documents\\Python\\Main Projects\\Final.py\\bills/"+str(self.bill_no.get())+".txt",'w')
    ...
    def find_bill(self):
        present="no"
        for i in os.listdir("C:\\Users\\HIYA\\OneDrive\\Documents\\Python\\Main Projects\\Final.py\\bills/"): 
            if i.split('.')[0]==self.search_bill.get():
                f1=open(f"C:\\Users\\HIYA\\OneDrive\\Documents\\Python\\Main Projects\\Final.py\\bills/{i}","r")
                self.txtarea.delete('1.0',END)
                for d in f1:
